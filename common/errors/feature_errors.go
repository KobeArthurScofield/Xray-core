...
// Important note: Only use this when the target migrating feature is under construction. For plans that has not start to construct yet, do not use.
// Important note: Even when the target migrating feature has finished its construction, this notice can still be used yet before turning the old feature into deprecated.
